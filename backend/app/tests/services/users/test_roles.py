...
class TestUserRoles:
    ...
    def test_add_role_with_all_data_present(self, mock_creator_in_list, mock_find_unique_data, muids, github_data):
    ...
    @patch("app.services.users.roles.search.find_unique_data")
    @patch("app.services.users.roles.utils.check_creator_github_handle_in_list")
    def test_add_role_with_data_only_in_muids(self, mock_creator_in_list, mock_find_unique_data, muids, github_data):
        mock_find_unique_data.return_value = muids
    ...
    @patch("app.services.users.roles.search.find_unique_data")
    @patch("app.services.users.roles.utils.check_creator_github_handle_in_list")
    def test_add_role_with_data_only_in_projects(self, mock_creator_in_list, mock_find_unique_data, github_data):
    ...
    @patch("app.services.users.roles.search.find_unique_data")
    @patch("app.services.users.roles.utils.check_creator_github_handle_in_list")
    def test_add_role_with_data_only_in_publication(self, mock_creator_in_list, mock_find_unique_data, github_data):
        mock_find_unique_data.return_value = []
    ...
    @patch("app.services.users.roles.search.find_unique_data")
    @patch("app.services.users.roles.utils.check_creator_github_handle_in_list")
    def test_add_role_with_empty_user_data(self, mock_creator_in_list, mock_find_unique_data, muids):
        mock_find_unique_data.return_value = muids
        mock_creator_in_list.side_effect = [True, True]
    ...
    def test_get_role(self, mock_get_json_data, github_data, users):
    ...
    def test_get_role_user_does_not_exist(self, mock_get_user):
        mock_get_user.side_effect = IndexError
        with pytest.raises(IndexError):
            get_role(-1)

    @patch("app.services.users.roles.utils.get_user")
    def test_get_role_incorrect_role(self, mock_get_user, user):
        user_data = user
